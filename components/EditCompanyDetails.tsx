    ...
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
        ...
        <div className="p-8 space-y-8">
          ...
          {/* CORE REGISTRY DATA (Only for New Entries) */}
          {isNew && (
             <div className="space-y-4 bg-blue-50/50 p-6 rounded-xl border border-blue-100">
                <h3 className="font-bold text-blue-900 text-sm uppercase tracking-wide border-b border-blue-100 pb-2 flex items-center gap-2">
                    <FileText className="w-4 h-4" /> Core Registry Data
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label className="block text-xs font-bold text-slate-500 mb-2">Entity Name</label>
                        <input
                            type="text"
                            id="editName"
                            placeholder="e.g. Salone Tech Ltd"
                            className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none text-sm font-bold text-slate-900"
                        />
                    </div>
                    <div>
                         <label className="block text-xs font-bold text-slate-500 mb-2">Registry Code</label>
                         <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-3 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none text-sm font-mono"
                            />
                         </div>
                    </div>
                    <div>
                         <label className="block text-xs font-bold text-slate-500 mb-2">Legal Form</label>
                         <select id="editLegalForm" className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none text-sm">
                    ...
                    <div>
                         <label className="block text-xs font-bold text-slate-500 mb-2">Registration Date</label>
                         <div className="relative">
                             ...
                             <input
                                ...
                                className="w-full pl-10 pr-4 py-3 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none text-sm"
                             />
                         </div>
                    </div>
                </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  id="editEmail"
                  disabled={!isBusiness && !isNew} // Admin can set initial email on creation if needed, but per rule let's strict lock unless business
            ...
            <div>
              ...
              <input
                ...
                id="editAddress"
                disabled={!isBusiness && !isNew} // Allow admin to set initial address
                className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none text-sm disabled:opacity-60 disabled:cursor-not-allowed disabled:bg-slate-100"
              />
            </div>
            <div>
